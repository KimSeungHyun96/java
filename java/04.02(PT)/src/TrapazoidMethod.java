...
public class TrapazoidMethod extends Base {
	double height = 0;
	double baseLine = 0;
	double baseTop = 0;

	public TrapazoidMethod(String name) {
		super(name);
	}
	...
	public void inValue() {
		...
		userInput = scanner.nextLine();
		this.baseTop = Double.parseDouble(userInput);
	}

	public void outValue() {
		super.result = (this.baseLine + this.baseTop) * this.height / (double) 2;
